    ...
    <div class="row">
      <div class="col-lg-9 col-sm-12">
        <div class="container card m-content-2">
          ...
          <h1 class="fw-bolder text-center">Curug Cigangsa, Warisan Alam yang Memanjakan Wisatawan</h1>
          <p class="text-center">Oleh Faizal Abdul Hakim - <span class="fw-semibold">1 Desember 2022</span></p>
          <div class="detail-img">
            <img src="Assets/img/artikel-1.jpg" class="object-fit-cover" alt="...">
          </div>

          <article class="my-3 fs-6">
            Sudah punya destinasi untuk liburan akhir pekan? Jika belum, coba ajak keluarga Anda berlibur ke Curug Cigangsa. Curug Cigangsa atau Curug Luhur merupakan salah satu dari sekian banyak destinasi wisata yang ada di Kawasan Geopark Ciletuh, Kabupaten Sukabumi. Air terjun tiga tingkat dengan pemandangan hijau persawahan dan pepohonan rindang. <br><br>
            Curug Cigangsa terbentuk akibat gempa yang kemudian membentuk dinding batu hitam yang indah. Fakta unik Curug Cigangsa adalah penamaan objek wisata yang konon diambil dari nama seorang tokoh masyarakat Eyang Gangsa. Tempat wisata ini bisa dikatakan aman karena debit airnya yang tidak terlalu kecil dan air terjun yang tidak terlalu tinggi.<br><br>
            Pemandangan yang memanjakan mata Wisatawan akan disuguhkan pemandangan yang menyegarkan mata bahkan sebelum tiba di Curug Cigangsa. Sepanjang perjalanan menuju Curug Cigangsa, wisatawan bisa menikmati pemandangan persawahan yang dipadukan dengan udara segar dari pepohonan yang rindang.<br><br>
          ...
          <div class="mb-4 card">
            <div class="card">
              <div class="px-4 py-4 card-body">
                <h4 class="mb-4 text-center card-title fw-bold">Artikel Lain</h4>
    
                <div class="my-4 card">
                  <img src="Assets/img/artikel-2.jpg" />
                  <div class="card-body">
