...
<body class="bg-primary-color">
  ...
  <!-- Content -->
  <div class="container-fluid bg-dark text-light background-hotel">
    <div class="container jumbotron text-center">
        <div class="display-4 fs-1 fw-bolder">Hotel</div>
    </div>
  </div>
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <div class="card-carousel">
                ...
                <div class="card-body p-4">
                    <h5 class="card-title fw-bolder">Hotel Ciletuh Si Tara</h5>
        ...
        <div class="carousel-item active">
            <div class="card-carousel">
                ...
                <div class="card-body p-4">
                    <h5 class="card-title fw-bolder">Hotel Cimaja Indah</h5>
        ...
        <div class="carousel-item active">
            <div class="card-carousel">
                ...
                <div class="card-body p-4">
                    <h5 class="card-title fw-bolder">Hotel Bang Agus Cisodong</h5>
        ...
        <div class="carousel-item active">
            <div class="card-carousel">
                ...
                <div class="card-body p-4">
                    <h5 class="card-title fw-bolder">Hotel Mas Tiwi Cugenang</h5>
                    <p class="card-text mt-2">Meski Pantai Ujung Genteng berada pada garis pantai laut selatan...</p>
                    <a href="#" class="btn btn-success bg-geo-success text-light">Lihat</a>
                </div>
            </div>
        ...
        <div class="carousel-item active">
            <div class="card-carousel">
                ...
                <div class="card-body p-4">
                    <h5 class="card-title fw-bolder">Hotel Bu Mega-chan</h5>
                    <p class="card-text mt-2">Meski Pantai Ujung Genteng berada pada garis pantai laut selatan lalu...</p>
                    <a href="#" class="btn btn-success bg-geo-success text-light">Lihat</a>
                </div>
            </div>
        ...
        <div class="carousel-item active">
            <div class="card-carousel">
                ...
                <div class="card-body p-4">
                    <h5 class="card-title fw-bolder">Hotel Cisolok</h5>
                    <p class="card-text mt-2">Geological Park atau sering kita sebut Geopark adalah kawasan yang memiliki unsur geologi...</p>
                    <a href="#" class="btn btn-success bg-geo-success text-light">Lihat</a>
                </div>
            </div>
