...
<head>
  ...
  <title>Merchant & Souveniers Detail</title>
    ...
    <div class="row d-flex justify-content-center">
      <div class="col-lg-10 col-sm-12">
        <div class="container card m-content-2">
          ...
          <h5 class="card-title fw-bolder">Toko Si Tara</h5>

          <div class="card mb-3">
            <img src="Assets/img/merchant-2.jpg" class="card-img-top" alt="...">
            <div class="card-body">
              ...
              <ol class="list-group list-group-numbered">
                <li class="list-group-item d-flex justify-content-between align-items-start">
                  <div class="ms-2 me-auto">
                    <div class="fw-bold">Manik-Manik Ciletuh</div>
                  </div>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-start">
                  <div class="ms-2 me-auto">
                    <div class="fw-bold">Gelang Kerang</div>
                  </div>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-start">
                  <div class="ms-2 me-auto">
                    <div class="fw-bold">Kalung Batu Delima</div>
                  </div>
                </li>
              </ol>
            </div>
